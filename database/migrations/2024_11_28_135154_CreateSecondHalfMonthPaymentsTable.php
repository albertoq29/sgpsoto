...
class CreateSecondHalfMonthPaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('segunda_quincena', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('cestaticket', 10, 2)->nullable();
    ...
    {
        Schema::dropIfExists('segunda_quincena');
    }
}
